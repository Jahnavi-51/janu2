...
def sendmail(to, subject='It is test API mail', body='It is successful'):
    ...
    server.login('b.jahnavi2001@gmail.com', 'qohl lekn hgll znaf')
...
def sendingemail(to,subject='Test Program to send a mail',body='hello!!!!'):
    print("starting")
    server =smtplib.SMTP_SSL('smtp.gmail.com', 465)
    print("connected")
    ...
    msg = EmailMessage()
    msg['From'] = 'b.jahnavi2001@gmail.com'
    msg['To'] = to
    msg['Subject'] = 'subject'
    msg.set_content(body)
...
sendingemail('bejawadajahnavi20@gmail.com') """
